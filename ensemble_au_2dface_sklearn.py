...
X_train_au, y_train_au = get_X_y(train_paths, FacialLandmarksOpenFace, " AU01_c", " AU45_c")
X_test_au, y_test_au = get_X_y(test_paths, FacialLandmarksOpenFace, " AU01_c", " AU45_c")
# X_val_au, y_val_au = get_X_y(val_path, FacialLandmarksOpenFace, " AU01_c", " AU45_c")

X_train_list = [X_train_face_2d, X_train_au]
X_test_list = [X_test_face_2d, X_test_au]
# X_val_list = [X_val_face_2d, X_val_au]

classifiers = [('svc_face', SVC(probability=True, kernel='rbf')), ('svc_au', SVC(probability=True, kernel='rbf'))]
...
with open("accuracies/EnsembleVotingMeanFacial2D_AU.txt", "a") as file:
